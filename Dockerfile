...
COPY server.py cockpit_api.py file_activity.py noc_mirror.py bridge_mirror.py studio_mirror.py curation_mirror.py decision_history_mirror.py carteiro_run_mirror.py README.md ./
COPY mocks/ ./mocks/
COPY docs/ ./docs/
