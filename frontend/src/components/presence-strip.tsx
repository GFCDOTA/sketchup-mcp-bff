// presence-strip.tsx — "No ar agora": quem está logado (logo/emoji + dot).
// CORE da Home (preferência dura do Felipe — nunca remover). Extraído do
// overview.tsx para a tela Hoje; o overview mantém a cópia inline até ser
// aposentado (tem WIP de outra sessão — não tocamos nele).
...
// OpenAI "blossom" branca sobre disco preto (path CC0 gilbarbara/logos).
const OPENAI_LOGO = (
